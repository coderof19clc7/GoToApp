class StringConstants {
  ...
  static const not_valid = "Không hợp lệ";
  static const must_include = "Phải gồm 1 chữ in, 1 chữ thường, 1 số, 1 ký tự đặc biệt và có ít nhất 8 ký tự";
  static const not_match_with = "Không khớp với";
